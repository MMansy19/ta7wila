...
export default function Services(){
   const translations  = useTranslation()
    return(
         <div className="flex flex-col lg:flex-row gap-4 items-center py-8  lg:px-8 w-full bg-black">
                <div className="flex flex-col flex-1 my-auto w-full basis-0 max-md:max-w-full mx-6 bg-gradient-to-b from-black to-[#161616] p-6 rounded-[120px] ">
                  ...
                  <div className="flex flex-wrap gap-4 items-center lg:p-9 mt-20 w-full text-black max-md:mt-10 ">
                    <div className={`flex overflow-hidden flex-col flex-1 shrink self-stretch px-16 pt-16 my-auto bg-neutral-400 basis-0 min-w-[260px] h-[350px] rounded-[72px] max-md:px-5`}>
                      <div className="flex flex-col">
        
                        <svg width="80" height="81" viewBox="0 0 80 81" fill="none" xmlns="http://www.w3.org/2000/svg" className=" ">
                        ...
                        <div className="flex flex-col mt-8 w-full">
                          <div className="text-2xl font-semibold leading-none">{translations.services.instantActivation.title}</div>
                          <div className="mt-3 text-xs lg:text-sm font-medium leading-5">{translations.services.instantActivation.description}</div>
                        </div>
                      </div>
                      <svg width="72" height="82" viewBox="0 0 72 82" fill="none" xmlns="http://www.w3.org/2000/svg" className="object-contain mt-8 aspect-[0.88] self-end">
                    ...
                    <div className={`flex overflow-hidden flex-col flex-1 shrink self-stretch px-16 pt-16 my-auto bg-[#F58C7B] basis-0 min-w-[260px] h-[350px] rounded-[72px] max-md:px-5`}>
                      <div className="flex flex-col">
                        <svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                        ...
                        <div className="flex flex-col mt-8 w-full">
                          <div className="text-2xl font-semibold leading-none">{translations.services.currencyConversion.title}</div>
                          <div className="mt-3 text-xs lg:text-sm font-medium leading-5">{translations.services.currencyConversion.description}</div>
                        </div>
                      </div>
                      <svg width="72" height="82" viewBox="0 0 72 82" fill="none" xmlns="http://www.w3.org/2000/svg" className="object-contain mt-8 aspect-[0.88] self-end">
                        <path d="M46.7869 23.4844C46.7869 23.4844 59.241 29.8111 62.1933 40.525C65.1458 51.2385 57.8971 62.5411 57.8971 62.5411C57.8971 62.5411 45.8615 56.4733 42.9086 45.7596C39.9561 35.0461 46.7869 23.4844 46.7869 23.4844Z" fill="white" />
                    ...
                    <div className={`flex overflow-hidden flex-col flex-1 shrink self-stretch px-16 pt-16 my-auto bg-[#A5CBAD] basis-0 min-w-[260px]  h-[350px] rounded-[72px] max-md:px-5`}>
                      <div className="flex flex-col">
                        <svg width="73" height="73" viewBox="0 0 73 73" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
                        ...
                        <div className="flex flex-col mt-8 w-full">
                          <div className="text-2xl font-semibold leading-none">{translations.services.support.title}</div>
                          <div className="mt-3 text-xs lg:text-sm font-medium leading-5">{translations.services.support.description}</div>
                        </div>
                      </div>
                      <svg width="72" height="82" viewBox="0 0 72 82" fill="none" xmlns="http://www.w3.org/2000/svg" className="object-contain mt-8 aspect-[0.88] self-end">
                        <path d="M46.7869 23.4844C46.7869 23.4844 59.241 29.8111 62.1933 40.525C65.1458 51.2385 57.8971 62.5411 57.8971 62.5411C57.8971 62.5411 45.8615 56.4733 42.9086 45.7596C39.9561 35.0461 46.7869 23.4844 46.7869 23.4844Z" fill="white" />
