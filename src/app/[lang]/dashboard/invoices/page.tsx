            ...
            <thead>
                <tr className="text-white/90 bg-gradient-to-r from-[#2A2A2A] to-[#1F1F1F] backdrop-blur-sm">
                  ...
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                      ...
                      <span>{translations.invoice.totalAmount}</span>
                    </div>
                  </th>
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                      ...
                      <span>{translations.invoice.totalFees}</span>
                    </div>
                  </th>
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                      ...
                      <span>{translations.invoice.lateFees}</span>
                    </div>
                  </th>
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                      ...
                      <span>{translations.invoice.developerFees}</span>
                    </div>
                  </th>
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                  ...
                  <th className="px-4 py-4 text-right font-semibold text-sm tracking-wide border-b border-white/10 last:rounded-tr-xl">
                    <div className="flex items-center justify-end gap-2 min-h-[24px]">
                      ...
                      <span>{translations.stores.table.actions}</span>
                    </div>
                  </th>
              </tr>
            </thead>
              ...
              {invoices.length > 0 ? (
                  invoices.map((invoice, rowIndex) => (
                    <tr key={invoice.id} className={`group transition-all duration-200 hover:bg-gradient-to-r hover:from-[#2A2A2A] hover:to-[#1F1F1F] border-b border-white/5 hover:border-white/10 ${rowIndex === invoices.length - 1 ? 'last:rounded-b-xl' : ''}`}>
                      ...
                      <td className="px-4 py-4 text-sm text-right group-hover:text-white/90 transition-colors duration-200">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <span className="font-medium text-blue-400">
                            {formatCurrency(invoice.total_fees)}
                          </span>
                        </div>
                      </td>
                      <td className="px-4 py-4 text-sm text-right group-hover:text-white/90 transition-colors duration-200">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <span className="font-medium text-red-400">
                            {formatCurrency(invoice.late_fees)}
                          </span>
                        </div>
                      </td>
                      <td className="px-4 py-4 text-sm text-right group-hover:text-white/90 transition-colors duration-200">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <span className="font-medium text-purple-400">
                            {formatCurrency(invoice.developer_fees)}
                          </span>
                        </div>
                      </td>
                      <td className="px-4 py-4 text-sm text-right group-hover:text-white/90 transition-colors duration-200">
                          ...
                          <div className="w-8 h-8 rounded-full bg-gray-500/20 flex items-center justify-center">
                            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              <span className="text-xs text-amber-400 font-medium">
                                {new Date(invoice.paid_at).toLocaleTimeString('ar-EG', { 
                                  hour: '2-digit', 
                                  minute: '2-digit',
                                  hour12: true 
                                })}
                      ...
                      <Link href={`/dashboard/invoicesDetails/${invoice.id}`}>
                            <button className="px-4 py-2 bg-gradient-to-r from-[#53B4AB]/20 to-[#53B4AB]/10 text-[#53B4AB] hover:from-[#53B4AB]/30 hover:to-[#53B4AB]/20 rounded-lg text-xs font-semibold border border-[#53B4AB]/30 transition-all duration-200 flex items-center gap-2">
                ...
                <tr>
                    <td colSpan={7} className="text-center py-12 text-white/60">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <span className="text-sm font-medium">{translations.invoice.noInvoices}</span>
                      </div>
                  </td>
                </tr>
              )}
