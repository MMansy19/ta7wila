        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-separate border-spacing-y-2">
            ...
            <tbody>
              {plans.length > 0 ? (
                plans.map((plan) => (
                  <tr key={plan.id} className="transition text-white text-center">
                    ...
                    <td className="p-2">
                      <div>
                        <button
                          ...
                          className="bg-[#1F1F1F] text-white px-4 py-2 mr-2 rounded-lg"
                        >
                          <svg
                            width="24"
                            height="24"
                        ...
                        <button
                          ...
                          className="bg-[#1F1F1F] text-white px-4 py-2 rounded-lg"
                        >
                          <svg
                            width="24"
                            height="24"
